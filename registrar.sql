...
SELECT pg_catalog.setval('courses_id_seq', 1212, true);
...
SELECT pg_catalog.setval('students_courses_id_seq', 385, true);
...
SELECT pg_catalog.setval('students_id_seq', 912, true);
